...
graph_index = create_instance(instance_type='static', size='medium', horizon=500, rddl_path='content/')
...
if mode == 'animate' or mode == 'both':
    animate_snapshot_sequence(predictor_type='tabular', predictor_filename=model_file_name, graph_index=graph_index)