...
# Simulation
parser.add_argument('-l', '--sim_log_window', type=int, default=16, help='Size of the logging window')
...
parser.add_argument('--n_evaluation_sequences', type=int, default=64, help='Number of evaluation sequences to create')
...
parser.add_argument('--animation_sequence_filepath', type=str, default='animation_sequences/log_window_255/1024_nodes/3841_snapshots/20231217_060346_4514.pkl', help='Path the animation sequence filename, relative to the bucket root.')
