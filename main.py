...
parser.add_argument('--hidden_layers', nargs='+', type=str, default="[[4], [32], [256], [4, 4], [32, 32], [256, 256]]", help='Hidden layers configuration for GNN')
...
parser.add_argument('--training_sequence_file_name', default='snapshot_sequences/snapshot_sequence_n1024_l3_static_small.pkl', help='Filename for training sequence')
parser.add_argument('--evaluation_sequence_file_name', default='snapshot_sequences/snapshot_sequence_n1_l3_static_small.pkl', help='Filename for evaulation sequence')
...
parser.add_argument('--animation_sequence_filename', default='snapshot_sequences/snapshot_sequence_n1_l3_static_small.pkl', help='Filename for animation sequence')
parser.add_argument('--predictor_filename', default='models/model_hl_[64, 64]_n_49005_lr_0.005_bs_256.pt', help='Filename for the predictor model')
